import { SegmentoPagoDetalleService } from './../../../_service/segmento-pago-detalle.service';
...
export class FacturasComponent implements OnInit {
  ...
  displayedColumnsCliente = ['facturaNumero', 'fecha', 'segmento', 'placa', 'total', 'pagada', 'fechaPago', 'tipoPago'];
