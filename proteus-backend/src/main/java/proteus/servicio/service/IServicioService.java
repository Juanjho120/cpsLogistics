...
public interface IServicioService extends ICRUD<Servicio, Integer> {
	...
	List<Servicio> getByFinalizadoAndFacturado(Boolean finalizado, Boolean facturado) throws Exception;
	...
	List<Servicio> getByFechaRango(String fechaDesde, String fechaHasta) throws Exception;
	List<Servicio> getByFechaAndFinalizadoAndFacturado(String fechaDesde, String fechaHasta, Boolean finalizado, Boolean facturado) throws Exception;
	...
	List<Servicio> getByServicioTipoAndFinalizadoAndFacturado(Integer idServicioTipo, Boolean finalizado, Boolean facturado) throws Exception;
	List<Servicio> getByCotizacion(Integer idCotizacion) throws Exception;
	List<Servicio> getNotInChecklist() throws Exception;
